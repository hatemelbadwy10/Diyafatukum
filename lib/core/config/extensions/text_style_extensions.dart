...
extension TextStyleEx on TextStyle {
  ...
  TextStyle setColor(Color color) => copyWith(color: color, decorationColor: color);
  ...
  TextStyle toCurrencyStyle() => copyWith(fontFamily: FontConstants.currencyFontFamily);
}
