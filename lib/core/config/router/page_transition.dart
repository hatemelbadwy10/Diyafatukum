...
CustomTransitionPage<dynamic> customTransitionPage(Widget child, PageTransitions? pageAnimation, Duration? duration) {
    ...
    case PageTransitions.slide:
      transitionsBuilder = (context, animation, secondaryAnimation, child) {
        ...
        return SlideTransition(
          position: Tween<Offset>(begin: Offset(isArabic ? 1.0 : -1.0, 0.0), end: Offset.zero).animate(animation),
          child: child,
        );
      };
      break;
