              ...
              children: [
                if (iconPath != null)
                  iconPath!.svg(
                    height: iconSize,
                    width: iconSize,
                    colorFilter: ColorFilter.mode(iconColor ?? context.primaryColor, BlendMode.srcIn),
                  )
                ...
                12.gap,
                if (subtitle != null)
                  Text(subtitle!, style: subtitleStyle ?? context.bodyLarge.s14.medium, textAlign: TextAlign.center),
                24.gap,
