...
class OverlayUtils {
  ...
  static void showCustomDialog({required BuildContext context, required Widget child, bool barrierDismissible = true}) {
    showDialog(
      context: context,
      useSafeArea: true,
      useRootNavigator: true,
      barrierDismissible: barrierDismissible,
      builder: (context) => Material(color: Colors.transparent, child: child).center(),
    );
  }
  ...
  static Future<T?> showBottomSheet<T>({required BuildContext context, required Widget child}) {
    return showModalBottomSheet(
      ...
      useSafeArea: true,
      shape: RoundedRectangleBorder(borderRadius: 8.topBorderRadius),
      ...
      builder: (BuildContext context) {
        return DraggableScrollableSheet(
          ...
          builder: (context, controller) => Column(
            children: [
              if (title != null) title.paddingBottom(8),
  ...
  static Future openSettingPermissionDialog({String? title, String? actionTitle, required String message}) {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(title ?? LocaleKeys.permissions_title.tr(), style: context.bodyLarge.s16.medium),
              16.gap,
              Text(message, style: context.bodyLarge.s14.regular),
            ],
